...
public class UserPatient {
    ...
    public UserPatient(int id, String firstnp, String middlenp, String lastnp, Date dobp, String genderp, String emailp, int telephonep, String addressp, Date datep) {
        this.id = id;
